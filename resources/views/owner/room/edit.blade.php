    ...
    <section class="container mx-auto">
        <div id="main" class="flex-1 h-full pb-24 mt-12 bg-gray-100 main-content md:mt-2 md:pb-5">
            ...
            <div class="flex justify-center">
                <form action="{{ route('owner.room.update', [$property, $room]) }}" method="POST"
                    enctype="multipart/form-data" class="w-full max-w-2xl p-8 bg-white rounded-lg shadow-md">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            placeholder="cth(Kamar no 1)" value="{{ old('name', $room->name) }}" required />
                        @error('name')
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="size" name="size"
                            ...
                            placeholder="cth(3 x 5 meter)" value="{{ old('size', $room->size) }}" required />
                        @error('size')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" id="price" name="price"
                            ...
                            placeholder="cth(5000000)" value="{{ old('price', $room->price) }}" required />
                        @error('price')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        @enderror
                        @if ($room->foto_room)
                            <img src="{{ Storage::url($room->foto_room) }}" alt="Room Image" class="w-full mb-4">
                        @endif
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-file"
                                ...
                                <!-- Input File -->
                                <input id="dropzone-file" value="" name="foto_room" type="file" class="hidden"
