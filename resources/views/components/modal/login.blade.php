<!-- Modal Container -->
<div id="authModal" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black/50 backdrop-blur-sm">
    <div
        ...
        <div class="flex items-center justify-between pb-4 border-b-2 border-primary/20">
            ...
            <button id="closeModal" class="p-1 text-3xl transition-colors text-primary/60 hover:text-primary sm:text-xl">
                &times;
            </button>
        </div>

        <!-- Modal Content -->
        <div class="mt-6 h-[calc(100%-80px)] sm:h-auto overflow-y-auto space-y-6">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    @if (Route::has('password.request'))
                        <a class="text-sm text-primary hover:text-primary/80" href="{{ route('password.request') }}">
                            {{ __('Forgot password?') }}
                        </a>
                    @endif
                </div>
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">
                    ...
                    {{-- <a href="#" class="font-medium text-primary hover:text-primary/80">Daftar disini</a> --}}
                </p>
            </div>
            ...
            <div class="space-y-4">
                <a href="#"
                    class="flex items-center justify-center w-full px-4 py-2.5 space-x-2 text-gray-900
                    bg-white border rounded-lg hover:border-primary/50 hover:bg-gray-50 transition-colors">
