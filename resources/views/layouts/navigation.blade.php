    ...
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto">
        ...
        <div class="flex items-center lg:order-2">
            ...
            @auth
                <button type="button" data-dropdown-toggle="language-dropdown"
                    class="flex items-center text-sm font-medium text-gray-700 dark:text-gray-400 focus:outline-none">
                    <img class="w-8 h-8 rounded-full" src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}"
                        alt="Profile Picture">
                    <span class="hidden ml-2 text-sm font-medium text-gray-700 dark:text-gray-400 lg:block">
                        {{ Auth::user()->name }}
                    </span>
                </button>
                <!-- Dropdown -->
                <div class="z-50 hidden w-48 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700"
        ...
        <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-search">
            ...
            <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                <li>
                    <a href="/"
                        class="block py-2 pl-3 pr-4 rounded {{ request()->is('/') ? 'text-primary-700' : 'text-gray-700' }} dark:hover:bg-gray-700 hover:bg-gray-50 lg:p-0 dark:text-white"
                        aria-current="page">Home</a>
                </li>
                <li>
                    <a href="{{ route('about') }}"
                        class="block py-2 pl-3 pr-4 {{ request()->routeIs('about') ? 'text-primary-700' : 'text-gray-700' }} border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-white lg:border-0 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">About</a>
                </li>
                {{-- <li>
                    <a href="#"
                        class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-white lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Kamar</a>
                </li> --}}
                <li>
                    <a href="{{ route('syarat&ketentuan') }}"
                        class="block py-2 pl-3 pr-4 {{ request()->routeIs('syarat&ketentuan') ? 'text-primary-700' : 'text-gray-700' }} border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-white lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">syarat
                        dan ketentuan</a>
                </li>
                <li>
                    <a href="https://wa.me/628786396844?text=Assalamualaikum"
